...
The roadmap is outcome-oriented and may change as production accountants test the system. Completed work remains visible in the Git history and releases.

## Now — public beta foundation

- [x] Hierarchical Topsheet, Account, Category and Detail workflow.
- [x] Globals, formulas, fringes, caps, currencies and incentives.
- [x] Multi-project cloud workspace with shared resources.
...
- [ ] Add project duplication and template-based project creation.
...
- [ ] Public extension points for importers, exporters and calculation presets.
- [ ] Accessibility audit and expanded keyboard navigation.

## How priorities are chosen

Priority is based on data safety, correctness of financial calculations, interoperability, accessibility and demonstrated production demand. Open a feature request describing the concrete workflow, expected result and example using synthetic data.
